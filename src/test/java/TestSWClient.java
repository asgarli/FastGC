...
import Program.SmithWatermanClient;
import Program.SmithWatermanCommon;
...
class TestSWClient {
    ...
    private static void printUsage() {
        System.out.println("Usage: java TestSWClient [{-c, --codons} codons] [{-L, --max-bit-length} L] "
                + "[{-a, --autogen}] [{-n, --protein-length} length] [{-s, --server} servername]");
    }
