...
import Program.EditDistanceClient;
import Program.EditDistanceCommon;
...
class TestEDClient {
    ...
    private static void printUsage() {
        System.out.println("Usage: java TestEDClient [{-d, --dna} dna] [{-L, --EDBitLength} L] "
                + "[{-a, --autogen}] [{-n, --DNALength} length] [{-s, --server} servername]");
    }
